...
def generateCARs(transactionDB, support=1, confidence=50, maxlen=10, **kwargs):
    ...
    **kwargs :
    ...
    # pyarc uses appriori by default.
    ...
    # rules = fim.eclat(transactionDB.string_representation, supp=support, conf=confidence, mode="o", target="r", report="sc", appear=appear, **kwargs, zmax=maxlen)
...
def top_rules(transactions,
    ...
    while flag:
        ...
        print("Running appriori with setting: confidence={}, support={}, minlen={}, maxlen={}, MAX_RULE_LEN={}".format(
