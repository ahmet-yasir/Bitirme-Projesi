...
class Classifier:
    ...
    def confusion_matrix(self, actual, predicted):
        """
        Function for determining confusion mattrix given
    ...
    def classification_report(self, actual, predicted):
        """
        Function for classification report derived from sklearn module
        """
        return metrics.classification_report(actual, predicted)
