...
class Antecedent(ComparableItemSet):
    ...
    def __getattr__(self, attr_name):
        ...
        """
        if 'itemset' not in self.__dict__ or self.itemset is None:
            raise AttributeError(f"'Antecedent' nesnesinde 'itemset' bulunamadı veya yüklenemedi")
        ...
        if item:
            ...
            raise AttributeError(f"'{attr_name}' adında bir attribute bulunamadı")
